...
export const ParticipantsTable = ({ participants, onEdit, onDelete, canEdit, canDelete }: TableProps) => {
  return (
          ...
          {participants.length === 0 ? (
            ...
            participants.map((participant) => (
              <tr key={participant.userId}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-md text-gray-500">{participant.rol}</td>
